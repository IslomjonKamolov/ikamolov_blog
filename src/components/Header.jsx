    ...
    return (
        <header>
            <div className="header__container">
                <Link className='header__logo' to="/">Ikamolov_blog</Link>
                <div className='header__menu__box'>
                    <a href="https://t.me/ikamolov_blog" target='_blank' className="telegram_icon">
                        <svg
                            viewBox="0 0 24 24"
                            version="1.1"
                    ...
                    <button onClick={() => setIsPassed(true)} className='open__postWriteMenu__btn'>
            ...
            {isPassed && <Input setIsPassed={setIsPassed}/>}
